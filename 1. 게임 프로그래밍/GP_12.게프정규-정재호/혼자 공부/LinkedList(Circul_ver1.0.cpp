...
void DelNode(hNODE * Header, NODE * pEnd, int data);//노드 제거
void DeleteCirLinkL(hNODE * Header);//리스트 삭제
...
int main(void) {
	...
	DelNode(Header, pEndNODE, 30);//30노드 제거
	PrintCirLinkL(Header, pEndNODE, 1);//리스트 출력
	DeleteCirLinkL(Header);//리스트 제거
	//PrintCirLinkL(Header, pEndNODE, 1);//리스트 출력
...
////노드 제거
void DelNode(hNODE * Header, NODE * pEnd, int data) {
	NODE* pStart = Header->DumNode.pLink;
...
////리스트 삭제
void DeleteCirLinkL(hNODE * Header) {
