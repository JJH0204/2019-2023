...
VOID SetupMatrices()
{
	...
	FLOAT fAngle = iTime * (0.5f * D3DX_PI) / 1000.0f;		/// 1000밀리초마다 한바퀴씩(2 * pi) 회전 애니메이션 행렬을 만든다.
    ...
    D3DXVECTOR3 vLookatPt( 0.0f, 0.0f, 1.0f );						/// 2. 눈이 바라보는 위치( 0, 0, 1 )
    D3DXVECTOR3 vUpVec( 0.0f, 1.0f, .0f );							/// 3. 천정방향을 나타내는 상방벡터( 0, 1, 0 )
